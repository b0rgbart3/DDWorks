...
<div class='footerWrapper'>
    <div class='footer group'>
        ...
        <div class='footerMenu group'>
            <h1>Privacy Policy regarding Starburst iPhone game:</h1>

        <!-- <img src='images/interface/ddw_wide_type.svg' class='wide_logotype'> -->
        <p>The starburst game for the iPhone does not collect or store any personal data from you or your device. <br>It doesn't connect with any external functions of your device such as the camera or your contacts list.</p>
